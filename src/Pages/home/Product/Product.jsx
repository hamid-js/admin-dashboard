            ...
            <div className="productTop">
                ...
                <div className="productTopRight">
                    <div className="productInfoTop">
                        <img src="/img/products/12T Pro.jpg" alt="Dell LapTop" className="productInfoImg" />
                ...
                <form className="productForm">
                    ...
                    <div className="productFormRight">
                        <div className="productUploader">
                            <img  src="/img/products/12T Pro.jpg" alt="profilePhoto" className="productUploaderImg" />
                            <label>
                                <PublishIcon />
                            </label>
